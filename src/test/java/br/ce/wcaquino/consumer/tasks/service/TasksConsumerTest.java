...
public class TasksConsumerTest {
    ...
    public void shouldGetAnExistingTask() throws IOException {
        ...
        //Act - acao
        Task task = consumer.getTask(1L); //inserindo variavel local

        //Assert
        Assert.assertNotNull(task);
        Assert.assertThat(task.getId(), CoreMatchers.is(1L)); // 1 em log
    }
}
